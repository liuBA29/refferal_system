...
SECRET_KEY = 'django-insecure-&53hw0ruil%s=amm=4elp6tig)if**v^ho#06z2**2(^q(!^-6'
...
# Сжатие и хэширование статики для продакшена (если будет использоваться whitenoise)
